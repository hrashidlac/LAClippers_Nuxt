<template>
  <div>
    ...
    <div class="container py-20 grid grid-cols-1 sm:grid-cols-3 gap-12">
      <div>
        <div class="flex flex-col justify-center items-center mb-12">
          ...
          <h2>LA Clippers</h2> 
          <div class="font-agency uppercase">Downtown Los Angeles, CA</div>
        </div>
      ...
      <div>
        <div class="flex flex-col justify-center items-center mb-12">
          ...
          <h2>Agua Caliente Clippers</h2> 
          <div class="font-agency uppercase">Ontario, CA</div>
        </div>
      ...
      <div>
        <div class="flex flex-col justify-center items-center mb-12">
          ...
          <h2>Forum</h2> 
          <div class="font-agency uppercase">Inglewood, CA</div>
        </div>
    ...
    <div class="text-white uppercase flex justify-center items-center h-300 bg-center bg-cover" style="background-image: url(https://www.nba.com/resources/static/team/v2/clippers/img/1440x369-living-header-bg-is-career-200219.jpg)">
      <h2 class="font-agencywide">Living in LA</h2>
    </div>
