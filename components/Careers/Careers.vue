<template>
  <div>
    ...
    <div class="container mt-24 grid grid-cols-1 lg:grid-cols-3 gap-12">
      <div>
        <div class="flex flex-col justify-center items-center mb-12">
          <img src="https://www.nba.com/resources/static/team/v2/clippers/img/180x130-clippers-global-logo.png">
          <h3 class="font-agbold uppercase">LA Clippers</h3> 
          <div class="font-agbold uppercase">Downtown Los Angeles, CA</div>
        </div>
      ...
      <div>
        <div class="flex flex-col justify-center items-center mb-12">
          <img src="https://www.nba.com/resources/static/team/v2/clippers/img/180x130-ac-clippers-logo.png">
          <h3 class="font-agbold uppercase">Agua Caliente Clippers</h3> 
          <div class="font-agbold uppercase">Ontario, CA</div>
        </div>
      ...
      <div>
        <div class="flex flex-col justify-center items-center mb-12">
          <img src="https://www.nba.com/resources/static/team/v2/clippers/img/180x130-forum-logo.png">
          <h3 class="font-agbold uppercase">Forum</h3> 
          <div class="font-agbold uppercase">Inglewood, CA</div>
        </div>
    ...
    <div class="container mt-24 lg:flex">
      <div class="lg:w-1/3 text-center"><h3 class="font-agbold uppercase">Location</h3></div>
    ...
    <div class="container mt-12 grid grid-cols-1 sm:grid-cols-3 gap-12">
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-location-1-is-career-200219.png">
      </div>
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-location-2-is-career-200219.png">
      </div>
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-location-3-is-career-200219.png">
      </div>
    </div>

    <div class="container mt-24 lg:flex">
      <div class="lg:w-1/3 text-center"><h3 class="font-agbold uppercase">Food Scene</h3></div>
    ...
    <div class="container mt-12 grid grid-cols-1 sm:grid-cols-3 gap-12">
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-food-1-is-career-200219.png">
      </div>
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-food-2-is-career-200219.png">
      </div>
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-food-3-is-career-200219.png">
      </div>
    </div>

    <div class="container mt-24 lg:flex">
      <div class="lg:w-1/3 text-center"><h3 class="font-agbold uppercase">Entertainment</h3></div>
    ...
    <div class="container mt-12 grid grid-cols-1 sm:grid-cols-3 gap-12">
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-entertainment-1-is-career-200219.png">
      </div>
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-entertainment-2-is-career-200219.png">
      </div>
      <div>
        <img src="https://www.nba.com/resources/static/team/v2/clippers/img/437x245-entertainment-3-is-career-200219.jpg">
      </div>
    </div>
