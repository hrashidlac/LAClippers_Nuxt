<template>
  <div>     
    ...
    <div class="row-full photos">
      <div class="container">
        <h2 class="text-center section-title"><span>FAN EXPERIENCES</span></h2>
        <div class="row">
          <div class="col-sm-12">
            <TicketCentralPhotos/>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div id="h-form">
            ...
            <p>Complete the signup form and we'll get in touch!</p>
...
<style src="../../assets/css/ticketcentral/style.css" scoped></style>
